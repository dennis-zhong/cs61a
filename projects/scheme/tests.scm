...
(define x "testing define")
x
; expect "testing define"

(/ 1 0)
; expect Error

'(1 ,x 3)
; expect (1 (unquote x) 3)

`(1 ,x 3)
; expect (1 "testing define" 3)

((lambda (x y) (+ x y) (- x y)) 1 2)
; expect -1

(eval (define x (((lambda () (lambda () "nested lambda"))))))
; expect "nested lambda"

(define (f) (print "testing no arg function"))
(f)
; expect f ; "testing no arg function"

((begin (define x "testing begin") (print x) (lambda () (+ 1 2))))
; expect "testing begin" ; 3

(or 0 (and nil 2) (/ 1 0))
; expect 0

(if #f (print "works") (else (print "doesn't work")))
; expect Error

(cond ((null? "hi") (begin (/ 1 0) x)) (else (print "testing cond")))
; expect "testing cond"

(define mu-test (mu () (print x)))
x
((lambda () (define x "testing dynamic") (mu-test)))
; expect mu-test ; "testing begin" ; "testing dynamic"

(let ((x "testing let")) (mu-test))
(mu-test)
; expect "testing let" ; "testing begin"

(begin (define x "wrong") (define nested-mu (mu (x) (mu-test))) (nested-mu "testing nested mu"))
; expect "testing nested mu"

(begin (define-macro (macro-test x) `(print ,x)) (macro-test "macro works"))
; expect "macro works"

(begin (define-macro (macro-test x) `(mu-test))
(define x "dynamic scope") (macro-test "doesn't matter what input"))
